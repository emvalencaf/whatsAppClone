    ...
    getViewElement(me = true){
        ...
        switch(this.type){
                        ...
                        <div class="_3DZ69" role="button">
                            ...
                            <div class="_3a5-b">
                                <div class="_1DZAH" role="button">
                                    <span class="message-time">${FormatTimestamp.timestampToTime(this.timestamp)}</span>
                                </div>
                            </div>
                        </div>
                        <div class="_6qEXM">
            ...
            case 'audio':
                ...
                const audioDuration = div.querySelector('.message-audio-duration')
                ...
                audioEl.ontimeupdate = e => {
                    ...
                    btnPlay.hide()
                    btnPause.hide()
                    audioDuration.innerHTML = FormatTimestamp.toTime(audioEl.currentTime * 1000)
                ...
                audioEl.onpause = e => {
                    ...
                    audioDuration.innerHTML = FormatTimestamp.toTime(this.duration * 1000)
                    btnPlay.hide()
                    btnPause.show()
...
*/
    ...
    static sendAudio(chatId, from, file, metadata, photo){
        ...
        return MessageService.send(chatId,
            from,
            'audio',
            '')
                .then(msgRef => {
